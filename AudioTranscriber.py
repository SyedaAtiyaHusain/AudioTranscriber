...
def transcribe(recording):
    ...
    #Iterating through the number of audio generated through the above code 
    #and transcribing them using recognize_google function present in SpeechRecognition library    
    for k in range(3):  
        string=""
        for i in range(len(Audio_Parts_List)):
            r=sr.Recognizer()
